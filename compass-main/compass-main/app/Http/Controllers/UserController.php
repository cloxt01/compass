...
class UserController
{
    ...
    public function application_stats(Request $request)
    {
        ...
        $stats = DB::table('applications')
            ...
            // SEKARANG DIPISAH: Murni success dan murni applied
            ...
            // Performa hari ini (tetap menghitung total aksi sukses + skip duplikat hari ini)
        ...
        return response()->json([
            'stats' => [
                ...
                'success'       => (int) $stats->success,       // Tambahkan key ini untuk card Murni Success
                'applied'       => (int) $stats->applied,       // Sekarang murni berisi data status applied (skip/duplikat)
