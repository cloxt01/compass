...
<aside id="sidebar"
    ...
    <nav class="flex flex-col gap-0.5 px-3 py-4 text-sm h-[calc(100%-4rem)] overflow-y-auto">
        ...
        <a href="{{ route('career-match') }}"
           data-testid="sidebar-career-match-link"
           class="flex items-center gap-3 rounded-md px-3 py-2 transition-colors duration-200 {{ request()->routeIs('career-match*') ? 'bg-[#1e1e1e] text-[#fafafa]' : 'text-[#a1a1aa] hover:bg-[#1e1e1e] hover:text-[#fafafa]' }}">
            <i data-lucide="sparkles" class="w-4 h-4 opacity-70"></i>
            <span>CareerMatch AI</span>
        </a>
