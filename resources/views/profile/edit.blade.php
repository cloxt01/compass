...
<div class="space-y-4">
    ...
    <div class="bg-[#0a0a0a] border border-[#262626] rounded-md">
        <div class="px-5 py-4 border-b border-[#262626]">
            <h2 class="text-sm font-semibold text-[#fafafa]">
                Account Settings
            </h2>
        </div>
        ...
        <form action="{{ route('settings.profile.update') }}" method="POST" class="p-5 space-y-4">
            ...
            <div>
                <label class="block text-xs font-medium text-[#a1a1aa] uppercase tracking-wider mb-2">
                    Full Name
                </label>
    ...
    {{-- Delete Account --}}
    <div class="bg-[#0a0a0a] border border-red-500/20 rounded-md">
