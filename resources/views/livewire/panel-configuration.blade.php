...
@if(auth()->user()->getLastActiveSubscription()->isLimit())
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-xs text-[#a1a1aa] sm:text-sm">
                    Kelola proses lamaran otomatis.
                </p>
            </div>

            <button
                disabled
                class="h-9 rounded-md border border-[#333] bg-[#1a1a1a] px-5 text-sm font-medium text-[#71717a] cursor-not-allowed">
                Tidak tersedia
            </button>
        </div>
        ...
        <div class="mt-5 flex flex-col">
            ...
            <div class="flex min-h-[170px] flex-1 flex-col rounded-xl border border-[#262626] bg-[#0a0a0a] p-3 sm:p-4 opacity-70">

                <div class="flex-1 space-y-3">

                    {{-- JobStreet --}}
                    <label class="flex items-center justify-between rounded-lg border border-[#262626] bg-[#111111] px-3 py-3">
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-[#71717a]">
                                Gunakan akun JobStreet untuk melamar otomatis.
                            </p>
                        </div>
                        ...
                        <label class="relative inline-flex cursor-not-allowed items-center">
                            ...
                            <div class="h-6 w-11 rounded-full bg-[#1f1f1f]"></div>
                    ...
                    <label class="flex items-center justify-between rounded-lg border border-[#262626] bg-[#111111] px-3 py-3">
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-[#71717a]">
                                Gunakan akun Glints untuk melamar otomatis.
                            </p>
                        </div>
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-amber-200/80">
                        Paket Anda telah mencapai jumlah akun maksimum. Upgrade paket untuk menambahkan akun baru.
                    </p>
                </div>

                <a
                    href="{{ route('billing.packages') }}"
                    class="inline-flex h-10 items-center justify-center rounded-md bg-amber-400 px-4 text-sm font-semibold text-black transition hover:bg-amber-300">
                    Upgrade Paket
                </a>
            </div>
        </div>
